...
import { ShareButtons } from "@/components/blocks/button/share-buttons";
import LikeButton from "@/components/blocks/button/like-button";
import ReactMarkdown from "react-markdown";
import remarkGfm from "remark-gfm";
import { CodeBlock } from "@/components/ui/code-block";
import { Info } from "lucide-react";
import AIChatButton from "@/components/blocks/button/ai-chat-button";
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  code: ({ className, children, ...props }) => {
                    ...
                    return (
                      <div className="my-6">
                        <CodeBlock language={language} filename={`code.${language}`} code={code} />
                      </div>
                    );
                  },
                  blockquote: ({ children }) => (
